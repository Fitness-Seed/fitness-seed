...
export class NutritionPage implements OnInit {
  ...
  items = [
    ...
    consumed to provide nutritional support for the body. It is produced either by Plants or Animals, and contains essential nutrients, such as carbohydrates, fats, proteins, vitamins, or minerals`},
